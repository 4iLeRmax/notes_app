...
export default function SyncDataBtn({
  ...
  // Tracks whether we've seen the first render, and the previous
  // isPending value, so we only react to true -> false transitions.
  ...
  useEffect(() => {
    ...
    // Only flash the check when a pending operation just completed,
    // not on mount and not when isPending was already false.
